...
function IHaveArguments(a, b, c) -- Arguments, just like normal variables, take no type, just a name
    print(a, b, c)
end

function FuncArg(func) -- And just like other variables, they can take functions as arguments
    func()
end
