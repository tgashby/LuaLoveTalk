...
if tag == "awesome" then -- if, elseif followed by 'then', else isn't.... enjoy that.
...
local start, limit, incr = 1, 10, 2
for j = start, limit, incr do -- The classic with assignemnt, condition, step
    print(j)
end
...
print("I bet you forgot that Lua arrays start at index 1... I certainly did.")